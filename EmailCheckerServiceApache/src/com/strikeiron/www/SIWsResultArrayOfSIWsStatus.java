...
public class SIWsResultArrayOfSIWsStatus  implements java.io.Serializable {
    private com.strikeiron.www.SIWsStatus[] results;

    public SIWsResultArrayOfSIWsStatus() {
    }

    public SIWsResultArrayOfSIWsStatus(
           com.strikeiron.www.SIWsStatus[] results) {
     ...
     * @return results
     */
    public com.strikeiron.www.SIWsStatus[] getResults() {
        return results;
    }
     ...
     * @param results
     */
    public void setResults(com.strikeiron.www.SIWsStatus[] results) {
        this.results = results;
    }

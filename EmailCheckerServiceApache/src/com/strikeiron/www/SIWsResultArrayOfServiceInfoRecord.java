...
public class SIWsResultArrayOfServiceInfoRecord  implements java.io.Serializable {
    private com.strikeiron.www.ServiceInfoRecord[] results;

    public SIWsResultArrayOfServiceInfoRecord() {
    }

    public SIWsResultArrayOfServiceInfoRecord(
           com.strikeiron.www.ServiceInfoRecord[] results) {
     ...
     * @return results
     */
    public com.strikeiron.www.ServiceInfoRecord[] getResults() {
        return results;
    }
     ...
     * @param results
     */
    public void setResults(com.strikeiron.www.ServiceInfoRecord[] results) {
        this.results = results;
    }
